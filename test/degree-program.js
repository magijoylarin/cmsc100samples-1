...
describe('Degree Program', function () {
	...
	describe('find()', function () {
		it('should retrieve all degree program records', function () {
			server
				.get('/degree-programs')
	...
	describe('findOne()', function () {
		it('should retrieve a degree program record', function () {
			server
	...
	*/
	...
	describe('update()', function () {
		it('should update a specific degree program record: degree_code, description, total_units field only', function () {
			var update = {
				'degree_code': 'BSCS',
			...
			server
				...
				.end(function(err, res) {
					if(err){
						...
						res.body.should.have.property('description','Bachelor of Science in Computer Science');
						done();
					}
				})
		});
	...
	describe('remove()', function () {
		it('should remove a specific degree program record', function () {
			var deleteId = {
				'id': 4
			}
			server
